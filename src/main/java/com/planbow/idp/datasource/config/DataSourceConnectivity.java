package com.planbow.idp.datasource.config;


import com.planbow.idp.datasource.util.DataSourceConfig;
import com.planbow.idp.datasource.util.DataSourcePoolConfig;
...
public class DataSourceConnectivity {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        localContainerEntityManagerFactoryBean.setPackagesToScan("com.planbow.idp.entities");
